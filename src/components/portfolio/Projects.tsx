...
const projects: Project[] = [
  ...
  },
  {
    ...
    stack: ["React", "TypeScript", "PostgreSQL", "Supabase", "EmailJS", "Tailwind CSS", "Zustand", "Vite", "React Query"],
  ...
  },
  {
    ...
    stack: ["Next.js", "React", "Socket.io", "Prisma", "Tailwind CSS", "PostgreSQL", "NextAuth", "Zustand"],
  ...
  },
  {
    ...
    stack: ["React", "Node.js", "Express.js", "Docker", "Drizzle ORM", "PostgreSQL", "Supabase", "Redis", "TypeScript", "Tailwind CSS", "JWT", "Nginx"],
          ...
          {projects.map((p, i) => {
            ...
            return (
              <motion.article
                variants={item}
                key={p.title}
                className="glass gradient-border group relative flex flex-col rounded-3xl p-6 transition-all duration-300 hover:-translate-y-2 hover:shadow-[var(--shadow-glow-violet)]"
              >
